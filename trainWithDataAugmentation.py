...
print('debug')
augmentations_list = [
    K.RandomRotation(args.degrees, p=1.0),
...
print('debug2')
if args.use_horizontal_flip:
    augmentations_list.insert(2, K.RandomHorizontalFlip(p=0.5))

if args.augmentation_device == "cuda":
    gpu_augmentation = T.Compose(augmentations_list)
